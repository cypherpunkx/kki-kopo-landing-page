...
export default function Home() {
  const jsonLd = {
    ...
    "description": "Dojo resmi Kushin Ryu M Karate-Do Indonesia (KKI) di Kota Bandung, Situsaeur. Melatih fisik, mental, pertahanan diri, dan membina atlet berprestasi.",
    ...
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Gg. Cetarip Timur II No.4, Situsaeur, Kec. Bojongloa Kidul",
